...
class FormFinitoWidgetsDemo extends StatefulWidget {
  const FormFinitoWidgetsDemo({super.key});

  @override
  State<FormFinitoWidgetsDemo> createState() => _FormFinitoWidgetsDemoState();
}

class _FormFinitoWidgetsDemoState extends State<FormFinitoWidgetsDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Universo Finito'),
      ),
      body: Form(
        key: _formKey,
        child: Scrollbar(
                      ...
                      ...[
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            filled: true,
                            hintText: 'N',
                            labelText: 'Tamaño de la Poblacion o Universo',
                          ),
                          onChanged: (value) {
                            setState(() {
                        ...
                        TextFormField(
                          ...
                          onChanged: (value) {
                            setState(() {
                              formData.nc = double.tryParse(value) ?? 0;
                            });
                          },
                        ),
                        TextFormField(
